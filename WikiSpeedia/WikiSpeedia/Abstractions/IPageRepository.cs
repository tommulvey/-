...
namespace WikiSpeedia.Abstractions
{
    public interface IPageRepository
    {
        ...
        Task<int> GetPageIdByTitle(string name); // get a wiki page id by article name (clicked from ahref :P )
        Task<string> GetPageTextById(int id); // get a wiki page text based off of ID
        Task<string> GetPageTextByTitle(string name); // get a wiki page text by article name (clicked from ahref :P )
